// Flat C exports observed in Windows.Storage.ApplicationData.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef WINDOWS_STORAGE_APPLICATIONDATA_C_H
#define WINDOWS_STORAGE_APPLICATIONDATA_C_H
...
// Export: CleanupTemporaryState (ABI unverified)
// Export: DllGetClassObject (ABI unverified)

#ifdef __cplusplus
} // extern "C"
#endif
#endif // WINDOWS_STORAGE_APPLICATIONDATA_C_H
