//! Windissect-generated Rust FFI bindings for Windows.Storage.ApplicationData.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "D1122A17AA1E8E6B9E569924AA1D5453";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2992843268;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 36] = [87, 105, 110, 100, 111, 119, 115, 46, 83, 116, 111, 114, 97, 103, 101, 46, 65, 112, 112, 108, 105, 99, 97, 116, 105, 111, 110, 68, 97, 116, 97, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2992843268 { return 0; }
